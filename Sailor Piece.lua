...
local FarmModeAura = Get("FarmModeAura", "Above") -- Above / Behind / Below
...
local function AuraSystem()
    ...
    if dist > 10 then
        ...
        isTweening = false
        root.CFrame = mobRoot.CFrame * CFrame.new(0, FarmDistance, 0)
